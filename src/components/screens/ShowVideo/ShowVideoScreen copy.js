...
import { View, FlatList, Dimensions, Image, TouchableOpacity, StatusBar, ActivityIndicator, Permission } from 'react-native';
...
const ShowVideoScreen = ({ navigation, }) => {
    ...
    useEffect(() => {
        ...
        console.warn(navigation.state.params.video.video);
    ...
    function onPressAcount() {
        if (global[KEY_USER_DATA].id != video.user_id) {
            setPlayToggle(true)
    ...
    return (
        <View style={{ flex: 1, justifyContent: 'center' }}>
            ...
            >
                ...
                /> */}
                {
                    video != undefined && isOnScreen == true ?
                        // <Video
                        ...
                        //https://audition.s3.ap-south-1.amazonaws.com/VID_20200627_WA01621593766195.mp4
                        ...
                        //     endThumbnail={{ uri: video.thumbnail }}
                        ...
                        <Image
                            source={video != undefined ? { uri: video.thumbnail } : IMG_LOGO}
                            style={{ width: width, height: height }}
                            resizeMode='cover'
                        />
            ...
            <View style={{ position: 'absolute', right: 10, bottom: 10, marginRight: 10 }}>
                ...
                <TouchableOpacity style={{ alignItems: 'center' }} onPress={() => _shareImage()}>
