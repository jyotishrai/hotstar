...
{ title: (Strings.name) }, { title: (Strings.ratings_) }]
const box_w = 50
function RowReankingDetailPlayers({
    title, isYesTitle, paddingVertical, txtTitleColor, backgroundColor, textColor,
    index, teamname, matchNo, ratings, flag, name
}) {
                ...
                isYesTitle == undefined ?
                    <View style={{ flexDirection: 'row' }}>
                        ...
                        <RegularText
                            ...
                            font={FONT_FAMILY_HEEBO_REGULAR} style={{ flex: 1.5 }}
                        />
...
export default RowReankingDetailPlayers;